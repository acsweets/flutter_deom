...
typedef ColorSelectCallback = void Function(Color color);//给函数取个名
...
class ColorSelect extends StatefulWidget {
  ...
  const ColorSelect(
      {Key? key, required this.colors, this.radius = 25, required this.defaultColor, required this.onColorSelect})
      : super(key: key);
